...
void menu(void) {
    printf("\t****************************************************************************\n");
    printf("\t*    Voce esta prestes a ser atendido, escolha uma das opcoes abaixo:      *\n");
...
void menuPiscina(void){
    printf("\t****************************************************************************\n");
    printf("\t*    Qual piscina voce quer listar?                                        *\n");
...
void cadastraUsuario(void) {
    ...
    if (qtdCadastro < MAX_CAD) {
        ...
        do {
            //Valida se o cliente e atleta ou nao
...
void listarAtletas(void){
     ...
     * temos quer ver quais desses clientes, sao atletas [ok]
     * Imprime na console os clientes que sao atletas [ok]
     * */
    printf("\t***************************\n");
    printf("\tOs atletas cadastrados s?o:\n");
    for (int i = 0; i < qtdCadastro; ++i) {//iterar a variavel cliente ate atingir o numero cadastro
        if(cliente[i].atleta == 1){
            printf("\t %s\n", cliente[i].nome);
        }
    }
...
void buscarCadastro(void) {
    ...
    //Buscar por CPF ou Matricula
    printf("Informe o CPF ou matricula do cliente (informe apenas numeros): ");
    ...
    if (tam == 7) {
        ...
        printf("Numero informado e invalido.");
    }
    system("pause");
    system("cls");
}
